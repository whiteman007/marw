            ...
            <div class="datatable">
                             ...
                             foreach ($members as $member) {
                               echo "<tr>";
                                 ...
                                 echo '<td>
                                        ...
                                        <a href="members.php?do=Delete&userid=' . $member['UserID'] . ' "><button type="button" class="btn btn-danger btn-sm b0 confirm"> حذف <i class="fas fa-times"></i> </button></a>
                                        <a href="members.php?do=Edit&userid=' . $member['UserID'] . ' "><button type="button" class="btn btn-success btn-sm b0"> تعديل <i class="fas fa-edit"></i></button></a>
                                        </div>';
                                   if ($member['RegStatus']==0) {
                                    echo '<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                          <a href="members.php?do=Activate&userid=' . $member['UserID'] . ' "><button type="button" class="btn btn-info btn-sm b0"> تفعيل <i class="fas fa-check"></i></button></a>
                                          </div>';
                                       }
                                  echo'</td>';
                               echo "</tr>";
               ...
               <!--Table-->
                    <div class="text-center mt-1">
                      <a href='members.php?do=Add'><input class="btn btn-primary add-btn" type="button" value="اضافة عضو جديد" ><i class="fa fa-paper-plane-o ml-2"></i></a>
                    </div>
